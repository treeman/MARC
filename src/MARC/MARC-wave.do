...
add wave -noupdate -color {Cadet Blue} /marc_test/uut/ALU1_code
add wave -noupdate -color {Cadet Blue} /marc_test/uut/ALU2_code
add wave -noupdate -color {Cadet Blue} /marc_test/uut/ALU_code
