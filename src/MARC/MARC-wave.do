...
add wave -noupdate -group fifo /marc_test/uut/fifo/current_pc_in
add wave -noupdate -group fifo /marc_test/uut/fifo/current_pc_out
add wave -noupdate -group fifo /marc_test/uut/fifo/current_player
add wave -noupdate -group fifo /marc_test/uut/fifo/p1_head
add wave -noupdate -group fifo /marc_test/uut/fifo/p1_head_pc
add wave -noupdate -group fifo /marc_test/uut/fifo/p2_head
add wave -noupdate -group fifo /marc_test/uut/fifo/p2_head_pc
...
WaveRestoreCursors {{Cursor 1} {7197 ns} 0}
