...
add wave -noupdate /marc_test/start
...
add wave -noupdate /marc_test/uut/load
add wave -noupdate /marc_test/uut/game_over
add wave -noupdate /marc_test/uut/active_player
add wave -noupdate -group fifo /marc_test/uut/fifo/change_player
add wave -noupdate -group fifo -radix hexadecimal /marc_test/uut/fifo/current_pc_in
add wave -noupdate -group fifo -radix hexadecimal /marc_test/uut/fifo/current_pc_out
add wave -noupdate -group fifo /marc_test/uut/fifo/current_player
add wave -noupdate -group fifo -radix hexadecimal /marc_test/uut/fifo/p1_head
add wave -noupdate -group fifo -radix hexadecimal /marc_test/uut/fifo/p1_head_pc
...
add wave -noupdate -group mem1 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory1_data_in
add wave -noupdate -group mem1 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory1/data_out
...
add wave -noupdate -group mem2 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory2_data_in
add wave -noupdate -group mem2 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory2/data_out
...
add wave -noupdate -group mem3 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory3_data_in
add wave -noupdate -group mem3 -color {Slate Blue} -radix hexadecimal /marc_test/uut/memory3/data_out
